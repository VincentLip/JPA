...
public class ToDoListAppConsole {
    ...
    public static void main() {
        ...
        do {
            ...
            System.out.println("8. Ajouter une catégories");
            System.out.println("9. Supprimer une catégories");
            System.out.println("10. Afficher les tâches d'une catégories");
    ...
    private static void addTaskToCategory(Scanner scanner){
        ...
        Long taskId = scanner.nextLong();
        scanner.nextLine();
        System.out.println("Entrez l'ID de la catégorie pour cette tâche : ");
        Long categoryId = scanner.nextLong();
        scanner.nextLine();

        if(categoryDAO.addCategory(categoryId,taskId)){
            System.out.println("Tâche ajoutée avec succès !");
        }else {
            System.out.println("Erreur");
        }
