...
public class Ihm {
    ...
    private void addPicture(){
        ...
        try {
            pictureService.create(new Picture(url,p));
        }catch (Exception e){
            System.out.println(e.getMessage());
        }
    }
    ...
    private void addComment(){
        ...
        System.out.println("Merci de saisir la note du produit : ");
        int note = scanner.nextInt();
        scanner.nextLine();
        LocalDate date = LocalDate.now();
        try {
            commentService.create(new Comment(contain,date,note,p));
        }catch (Exception e){
            System.out.println(e.getMessage());
        }
    }
    ...
    private void note4(){
        List produits = produitService.filterByNote();
